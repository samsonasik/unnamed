...
if (version_compare('5.5', PHP_VERSION, '>')) {
    header('Content-Type: text/html; charset=utf-8');
    throw new \RuntimeException('Your server is running PHP version <b>%1$s</b> but Unnamed <b>%2$s</b> requires at least <b>%3$s</b> or higher</b>.', PHP_VERSION, '0.0.25', '5.5');
}
